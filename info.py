...
ADMINS.append(1216307744)
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
MAINTENANCE_MODE = is_enabled((environ.get('MAINTENANCE_MODE', "True")), True)
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📮 Uploaded By</b>: [EvaMaria](https://t.me/+KEUXcl2WUT02MzA1"))
...
MAINCHANNEL_ID = environ.get("MAINCHANNEL_ID", "-1001394587233")
